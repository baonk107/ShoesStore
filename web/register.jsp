                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-md-12">
                            <div class="form-block mx-auto">
                                ...
                                <form action="HomeController?do=register" method="post">
                                    <c:if test="${mess != null}">
                                    ...
                                    <div class="form-group first mb-3">
                                        ...
                                        <input required name="repass" value="${repass}" type="password" class="form-control" placeholder="Confirm Password" id="repassword">
                                    </div>
